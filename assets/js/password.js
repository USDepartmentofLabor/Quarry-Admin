...
!function ($) {
    ...
    Password.prototype.show = function(_relatedTarget) {
        var e = $.Event('show.bs.dbpassword', {relatedTarget: _relatedTarget});
    ...
    Password.prototype.hide = function(_relatedTarget) {
        var e = $.Event('hide.bs.dbpassword', {relatedTarget: _relatedTarget});
        this.$element.trigger(e);
    ...
    $.fn.password = function(option, _relatedTarget) {
        return this.each(function() {
            var $this = $(this),
                data = $this.data('bs.dbpassword'),
                options = $.extend({}, Password.DEFAULTS, $this.data(), typeof option === 'object' && option);

            if (!data) {
                $this.data('bs.dbpassword', (data = new Password(this, options)));
            }
